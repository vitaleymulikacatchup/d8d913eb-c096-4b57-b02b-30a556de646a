...
export const metadata: Metadata = {
  title: "Financial & Crypto Investment Advisory Services",
  description: "Expert financial advisor specializing in traditional investments and cryptocurrency portfolio management. Schedule your consultation today.",
  keywords: "financial advisor, cryptocurrency investment, portfolio management, retirement planning, investment advisory",
  metadataBase: new URL("https://financeadvisor.com"),
  alternates: {
    canonical: "https://financeadvisor.com"
  },
  openGraph: {
    title: "Financial & Crypto Investment Advisory Services",
    description: "Expert financial advisor specializing in traditional investments and cryptocurrency portfolio management. Schedule your consultation today.",
    siteName: "FinanceAdvisor",
    type: "website",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34kFQ1mvageIxtFsoHwjFOCooyh/uploaded-1763373462937-fng2vl75.jpg",
  ...
  twitter: {
    ...
    title: "Financial & Crypto Investment Advisory Services",
    description: "Expert financial advisor specializing in traditional investments and cryptocurrency portfolio management.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34kFQ1mvageIxtFsoHwjFOCooyh/uploaded-1763373462937-fng2vl75.jpg"]
  },
  robots: {
    index: true,
    follow: true
